...
from extasy.languages import *
from extasy.drivers import *
from extasy.actions import ActionRegistry
...
class Settings(object):
    def __init__(self,
        ...
        self.file_pattern = self.get_setting(settings, "file_pattern", "*.story")
