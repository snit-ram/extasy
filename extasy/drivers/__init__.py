...
DRIVERS = {}
from extasy.drivers.interface import DriverInterface
...
class BaseDriver(DriverInterface):
    ...
    def __init__(self, settings):
        ...
        if not settings or settings.__class__.__name__ != "Settings":
            raise TypeError('%s takes a extasy.common.Settings object as construction parameter. Got %s.' % (self.__class__.__name__, settings))
